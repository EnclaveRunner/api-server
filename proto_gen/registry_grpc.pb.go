...
type RegistryServiceClient interface {
	...
	PullArtifact(ctx context.Context, in *ArtifactIdentifier, opts ...grpc.CallOption) (RegistryService_PullArtifactClient, error)
	UploadArtifact(ctx context.Context, opts ...grpc.CallOption) (RegistryService_UploadArtifactClient, error)
...
func (c *registryServiceClient) PullArtifact(ctx context.Context, in *ArtifactIdentifier, opts ...grpc.CallOption) (RegistryService_PullArtifactClient, error) {
...
func (c *registryServiceClient) UploadArtifact(ctx context.Context, opts ...grpc.CallOption) (RegistryService_UploadArtifactClient, error) {
	stream, err := c.cc.NewStream(ctx, &RegistryService_ServiceDesc.Streams[1], "/registry.RegistryService/UploadArtifact", opts...)
	if err != nil {
		return nil, err
	}
	x := &registryServiceUploadArtifactClient{stream}
	return x, nil
}

type RegistryService_UploadArtifactClient interface {
	Send(*UploadArtifactRequest) error
	CloseAndRecv() (*Artifact, error)
	grpc.ClientStream
}

type registryServiceUploadArtifactClient struct {
	grpc.ClientStream
}

func (x *registryServiceUploadArtifactClient) Send(m *UploadArtifactRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *registryServiceUploadArtifactClient) CloseAndRecv() (*Artifact, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(Artifact)
...
type RegistryServiceServer interface {
	...
	PullArtifact(*ArtifactIdentifier, RegistryService_PullArtifactServer) error
	UploadArtifact(RegistryService_UploadArtifactServer) error
...
func (UnimplementedRegistryServiceServer) PullArtifact(*ArtifactIdentifier, RegistryService_PullArtifactServer) error {
	return status.Errorf(codes.Unimplemented, "method PullArtifact not implemented")
}
func (UnimplementedRegistryServiceServer) UploadArtifact(RegistryService_UploadArtifactServer) error {
...
func _RegistryService_UploadArtifact_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(RegistryServiceServer).UploadArtifact(&registryServiceUploadArtifactServer{stream})
}

type RegistryService_UploadArtifactServer interface {
	SendAndClose(*Artifact) error
	Recv() (*UploadArtifactRequest, error)
	grpc.ServerStream
}

type registryServiceUploadArtifactServer struct {
	grpc.ServerStream
}

func (x *registryServiceUploadArtifactServer) SendAndClose(m *Artifact) error {
	return x.ServerStream.SendMsg(m)
}

func (x *registryServiceUploadArtifactServer) Recv() (*UploadArtifactRequest, error) {
	m := new(UploadArtifactRequest)
